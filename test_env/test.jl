...
function construct_yaw_matrix_dynamic(x, sim, wf, num_yaw_changes, max_yaw_rate=Inf)   #wf to be used later
...
upper_bounds = vcat(ones(set_num_yaw_changes-1), 0.3 * ones(wf.nT))
