...
x0 = generate_initial_guess_individual_switches(sim, wind, wf, set_num_yaw_changes)  #start from scratch for baseline
con.yaw_data = construct_yaw_matrix_dynamic_individual_switches(x0, sim, wf, set_num_yaw_changes, set_max_yaw_rate)
